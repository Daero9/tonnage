...
const CACHE = "tonnup-beta-v10-20260921-0331";
const ASSETS = ["./", "./index.html", "./manifest.webmanifest", "./confidentialite.html", "./conditions.html", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png",
  ...
  "./img/abonnement.webp",
  "./img/logo-texte.png", "./img/couronne.png", "./img/play.png", "./img/drive.png", "./img/drive-blanc.png", "./img/onb-seances.jpg", "./img/onb-aliments.jpg", "./img/onb-charge.jpg", "./img/onb-progression.jpg", "./img/onb-seances-en.jpg", "./img/onb-aliments-en.jpg", "./img/onb-charge-en.jpg", "./img/onb-progression-en.jpg", 
